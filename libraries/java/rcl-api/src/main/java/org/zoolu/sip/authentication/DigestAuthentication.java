...
public class DigestAuthentication
{
   ...
   public DigestAuthentication(
		   ...
		   String username, 
		   String passwd)
   {  init(method,ah,body,username,passwd);
      this.uri=uri;
      this.qop=ah.getQop();
      this.username=username;
   }
		   ...
		   String passwd) 
   {
      ...
      this.username=username;
      this.passwd=passwd;
      this.realm=ah.getRealm();
      this.opaque=ah.getOpaque();
      this.nonce=ah.getNonce();
      this.algorithm=ah.getAlgorithm();
      this.qop=ah.getQop();
      this.uri=uri;
      this.cnonce=null;
      this.nc=null;
...
/** Sets A1 Digest Parameter. */
   ...
   private void init(String method, WWWAuthenticateHeader ah, String body, String username, String passwd)
   {  this.method=method;
      this.username=username;
      this.passwd=passwd;
      this.realm=ah.getRealm();
   ...
   {  return getAuthorizationHeader().getValue();
   }
